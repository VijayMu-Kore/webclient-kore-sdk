...
/***/ "./src/templatemanager/templates/fullsearchResultsTemplate/fullsearchResultsTemplate.ts":
/*!**********************************************************************************************!*\
  !*** ./src/templatemanager/templates/fullsearchResultsTemplate/fullsearchResultsTemplate.ts ***!
  \**********************************************************************************************/
...
/* harmony import */ var _fullsearchResultsTemplate_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fullsearchResultsTemplate.scss */ "./src/templatemanager/templates/fullsearchResultsTemplate/fullsearchResultsTemplate.scss");
...
/* harmony import */ var _feedBackFormTemplate_feedBackFormTemplate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../feedBackFormTemplate/feedBackFormTemplate */ "./src/templatemanager/templates/feedBackFormTemplate/feedBackFormTemplate.ts");
...
var FullSearchResultsTemplate = /** @class */ (function () {
    function FullSearchResultsTemplate() {
        this.$ = $;
    }
    FullSearchResultsTemplate.prototype.renderMessage = function (msgData) {
        var me = this;
        var $ = me.hostInstance.$;
        ...
        if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == 'fullSearchResultsTemplate') {
            ...
            me.feedBackTemplateObj = new _feedBackFormTemplate_feedBackFormTemplate__WEBPACK_IMPORTED_MODULE_7__["default"]();
            return me.messageHtml;
        }
    };
    FullSearchResultsTemplate.prototype.bindEvents = function (me, messageHtml, msgData) {
        ...
        var tabHtml = $(FullSearchResultsTemplate.prototype.getBottomupTab()).tmpl({ facets: msgData.message[0].component.payload.facets, truncateText: truncateText });
        ...
        setTimeout(function () {
            if ((hostWindowInstance.vars.selectedFiltersArr || []).length) {
                var filterCountHtml = $(FullSearchResultsTemplate.prototype.getFilterCountTemplate()).tmpl({ count: (hostWindowInstance.vars.selectedFiltersArr || []).length });
        ...
        if (msgData.message[0].component.payload.sortableFacetList && msgData.message[0].component.payload.sortableFacetList.length) {
            var sortableHtml = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsTabs()).tmpl({ sortablefacets: msgData.message[0].component.payload.sortableFacetList,
            ...
            var sortableAddedListHtml = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsAddedlist()).tmpl({
                displaySortable: msgData.message[0].component.payload.displaySortable
            });
    ...
    FullSearchResultsTemplate.prototype.getTemplateString = function (type) {
    ...
    FullSearchResultsTemplate.prototype.getBottomupTab = function () {
    ...
    FullSearchResultsTemplate.prototype.bindTabsClickEvent = function (me, messageHtml, facetSelected) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        $(messageHtml).find("[id='" + facetSelected + "']").addClass('active-tab');
        $(messageHtml).off("click", ".see-all-result-nav").on("click", ".see-all-result-nav", function (e) {
    ...
    FullSearchResultsTemplate.prototype.facetReset = function (me, messageHtml, msgData) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        var facetObj = {};
        ...
        if (facetData.length) {
            ...
            $(messageHtml)
                ...
                .on("click", "#facetRightIconId", function (event) {
    ...
    ;
    FullSearchResultsTemplate.prototype.facetFilter = function () {
        var facet = '<script type="text/x-jqury-tmpl">\
        <div>\
    ...
    ;
    FullSearchResultsTemplate.prototype.facetFilterTop = function () {
        var facet = '<script type="text/x-jqury-tmpl">\
          <div>\
    ...
    ;
    FullSearchResultsTemplate.prototype.facetTemplateTopIcon = function () {
        var facet = '<script type="text/x-jqury-tmpl">\
          <div>\
          {{if searchFacets.length}}\
    ...
    ;
    FullSearchResultsTemplate.prototype.bindFacetTriggerEvents = function (me, messageHtml) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        $(messageHtml)
        ...
        $(messageHtml)
            ...
            .on("change", ".sdk-filter-checkbox", function (event) {
            event.stopPropagation();
            event.stopImmediatePropagation();
            hostWindowInstance.facetCheckBoxClick(event).then(function (response) {
        ...
        $(messageHtml)
            ...
            .on("change", ".sdk-filter-radio", function (event) {
            event.stopPropagation();
            event.stopImmediatePropagation();
            hostWindowInstance.facetRadioClick(event).then(function (response) {
                if (response.isFilterAlignedTop) {
                    FullSearchResultsTemplate.prototype.applyFiltersFun(me, messageHtml);
                }
            });
        ...
        $(messageHtml)
            ...
            .on("click", ".sdk-clear-all-facet-top", function (event) {
            event.stopPropagation();
            event.stopImmediatePropagation();
            $(messageHtml).find(".filters-content").hide();
            $("#filter-count-container").empty();
            $(messageHtml).find(".sdk-filter-checkbox").prop("checked", false);
            hostWindowInstance.clearAllFilters().then(function (response) {
                var selectedFacet = $(messageHtml).find(".tab-name.see-all-result-nav.active-tab").attr('id');
                if (selectedFacet !== 'task' && selectedFacet !== 'all results') {
                ...
                var tabHtml = $(FullSearchResultsTemplate.prototype.getBottomupTab()).tmpl({ facets: response.facets, truncateText: truncateText });
                $(messageHtml).find('#sdk-bottomup-tab-container').empty().append(tabHtml);
                ...
                if (response.sortableFacetList && response.sortableFacetList.length) {
                    var sortableHtml = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsTabs()).tmpl({ sortablefacets: response.sortableFacetList,
        ...
        $(messageHtml)
            ...
            .on("click", ".sdk-top-facet-drop", function (event) {
            hostWindowInstance.dropdownFilterClickEvent(event);
            FullSearchResultsTemplate.prototype.bindFacetTriggerEvents(me, messageHtml);
        });
    };
    FullSearchResultsTemplate.prototype.fullResultTemplateDataBind = function (me, messageHtml, result) {
    ...
    FullSearchResultsTemplate.prototype.getFilterCountTemplate = function () {
    ...
    FullSearchResultsTemplate.prototype.applyFiltersFun = function (me, messageHtml) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        $(".filter-data").hide();
        $(messageHtml).find(".data-body-sec").addClass('filter-added-hide');
        hostWindowInstance.getSearchByFacetFilters().then(function (response) {
            ...
            $(messageHtml).find('#sdk-bottomup-tab-container').empty().append(tabHtml);
            FullSearchResultsTemplate.prototype.bindTabsClickEvent(me, messageHtml, selectedFacet);
            var filterCountHtml = $(FullSearchResultsTemplate.prototype.getFilterCountTemplate()).tmpl({ count: response.filterCount });
            $(messageHtml).find('#filter-count-container').empty().append(filterCountHtml);
            if (response.sortableFacetList && response.sortableFacetList.length) {
                var sortableHtml = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsTabs()).tmpl({ sortablefacets: response.sortableFacetList,
                    displaySortable: response.displaySortable });
    ...
    FullSearchResultsTemplate.prototype.filterCloseEvent = function (messageHtml, me) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
    ...
    FullSearchResultsTemplate.prototype.truncateText = function (val) {
        var textMsg = val;
    ...
    FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsTabs = function () {
    ...
    FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsAddedlist = function () {
    ...
    FullSearchResultsTemplate.prototype.bindSortableFacetClickEvent = function (me, messageHtml, sortableHtml, facets, sortableFacetAddedHtml) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        $(sortableFacetAddedHtml).off('click', '.clear-sort-by').on('click', '.clear-sort-by', function (event) {
            event.stopPropagation();
            $(".filter-data").hide();
            ...
            hostWindowInstance.sortableFacetClick(event, '').then(function (response) {
                ...
                if (response.sortableFacetList && response.sortableFacetList.length) {
                    var sortableHtml_1 = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsTabs()).tmpl({ sortablefacets: response.sortableFacetList,
                        displaySortable: response.displaySortable });
                    $(messageHtml).find('#sa-sdk-sortable-dropdown-bottom-up').empty().append(sortableHtml_1);
                    var sortableAddedListHtml = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsAddedlist()).tmpl({
                        displaySortable: response.displaySortable
                    });
                    $(messageHtml).find('#sa-sdk-sortable-facets-added-list').empty().append(sortableAddedListHtml);
                    FullSearchResultsTemplate.prototype.bindSortableFacetClickEvent(me, messageHtml, sortableHtml_1, selectedFacet, sortableAddedListHtml);
                }
            });
            ...
            setTimeout(function () {
                $(sortableHtml).off('click', '.sa-sortable-facet-options').on('click', '.sa-sortable-facet-options', function (event) {
                    ...
                    hostWindowInstance.sortableFacetClick(event, displaySortable).then(function (response) {
                        ...
                        if (response.sortableFacetList && response.sortableFacetList.length) {
                            var sortableHtml_2 = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsTabs()).tmpl({ sortablefacets: response.sortableFacetList,
                                displaySortable: response.displaySortable });
                            $(messageHtml).find('#sa-sdk-sortable-dropdown-bottom-up').empty().append(sortableHtml_2);
                            var sortableAddedListHtml = $(FullSearchResultsTemplate.prototype.getBottomUpSortableFacetsAddedlist()).tmpl({
                                displaySortable: response.displaySortable
                            });
                            $(messageHtml).find('#sa-sdk-sortable-facets-added-list').empty().append(sortableAddedListHtml);
                            FullSearchResultsTemplate.prototype.bindSortableFacetClickEvent(me, messageHtml, sortableHtml_2, selectedFacet, sortableAddedListHtml);
                        }
                    });
                    $(sortableHtml).find('.sa-sortable-dropdown').hide();
                });
    ...
    FullSearchResultsTemplate.prototype.feedBackResultEvents = function (me, messageHtml, feedbackData, msgData) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        $(messageHtml).find('.bottom-up-show-all-full').off('click', '.thumb-up-full-top').on('click', '.thumb-up-full-top', function (event) {
            var _a;
    ...
    FullSearchResultsTemplate.prototype.bindCustomizePreviewClickEvent = function (me, messageHtml) {
        var hostWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        $(messageHtml).find(".custom-header-nav-link-item")
            .off("click").on("click", function (e) {
            hostWindowInstance.customizePreviewBtnClick(e, false).then(function (result) {
                var formatedTemplatesData = result;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FullSearchResultsTemplate);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("850e4dcf502bb72c8396")
/******/ })();
/******/ 
/******/ }
)
