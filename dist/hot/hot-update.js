...
var FinalResultsTemplate = /** @class */ (function () {
    ...
    FinalResultsTemplate.prototype.renderMessage = function (msgData) {
        ...
        if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == 'finalResultsTemplate') {
            ...
            if ((_d = (_c = msgData === null || msgData === void 0 ? void 0 : msgData.message[0].component) === null || _c === void 0 ? void 0 : _c.payload) === null || _d === void 0 ? void 0 : _d.langTranslator) {
                    ...
                    message: [{
                            component: {
                                ...
                                payload: {
                                    ...
                                    feedbackData: null,
                                    langTranslator: (_a = msgData.message[0].component.payload) === null || _a === void 0 ? void 0 : _a.langTranslator
                                }
                            }
                        }]
                };
    ...
    FinalResultsTemplate.prototype.bindSnippetEvents = function (me, messageHtml) {
        ...
        $(messageHtml).find('.temp-fotter-actions').off('click', '.snippet-like-img').on('click', '.snippet-like-img', function (event) {
            ...
            if (!$(event.currentTarget).closest('.snippet-like-img').hasClass('active')) {
                var searchQuery = (_b = (_a = event === null || event === void 0 ? void 0 : event.currentTarget) === null || _a === void 0 ? void 0 : _a.closest('[data-query]')) === null || _b === void 0 ? void 0 : _b.getAttribute('data-query');
            ...
            message: [{
                    component: {
                        ...
                        payload: {
                            ...
                            query: searchQuery ? searchQuery : ((_a = hostWindowInstance === null || hostWindowInstance === void 0 ? void 0 : hostWindowInstance.vars) === null || _a === void 0 ? void 0 : _a.searchObject.searchText) || '',
                            feedBackType: feedBackType,
                            langTranslator: me === null || me === void 0 ? void 0 : me.langTranslator
                        }
                    }
                }]
        };
