(function(KoreSDK){
    ...
    botOptionsWiz.koreAPIUrl =  (window.JWT_OBJ && (window.JWT_OBJ.koreAPIUrl))? window.JWT_OBJ.koreAPIUrl:"https://bots.kore.ai";
    ...
    botOptionsWiz.botInfo = (window.JWT_OBJ && (window.JWT_OBJ.botInfo))?window.JWT_OBJ.botInfo:{ name: "PLEASE_ENTER_BOT_NAME", "_id": "PLEASE_ENTER_BOT_ID" }; // bot name is case sensitive
