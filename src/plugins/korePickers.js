...
class KorePickersPlugin {
    ...
    bindEvents(element) {
        ...
        $(element).on('click', '.sdkCalender.calenderBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(element).on('click', '.sdkRangeCalender.calenderBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(element).on('click', '.sdkAccount.accountBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(element).on('click', '.sdkMenu.menuBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
