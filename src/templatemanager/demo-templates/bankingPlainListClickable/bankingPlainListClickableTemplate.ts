            ...
            "template": '<script>\
                        <div class="results-web-content">\
                          ...
                          <div class="external-link-block">\
                            <a target="_blank" href="${data.url}" class="click-to-navigate-url faqs-shadow isClickable"  title="${data.heading}"><img src="https://koregeneric.s3.amazonaws.com/SearchAssist_UI_Img/Banking_demo/externallink-gray.svg"></a>\
