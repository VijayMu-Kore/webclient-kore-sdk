            ...
            "template": '<script>\
                          <div class="accordions-data-content-bt">\
                            ...
                            <div class="accr-template-b">\
                              <div class="accordion click-to-navigate-url faqs-shadow">{{html helpers.convertMDtoHTML(data.heading)}} <img src="https://koregeneric.s3.amazonaws.com/SearchAssist_UI_Img/Banking_demo/carrotright-black.svg" class="arrow-left"></div>\
                              <div class="panel">\
