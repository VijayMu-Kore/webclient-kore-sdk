  ...
  getTemplateString(type: any) {
    ...
    <div class="final-results-container">\
      ...
      <div class="snippet-template snippet-margin">\
        <div class="title position-relative"><div class="title-text">{{html snippetData?.title}}</div><div class="title-beta"><img src="https://koregeneric.s3.amazonaws.com/SearchAssist_UI_Img/Icons/beta_tag.svg"/></div></div>\
