  ...
  getTemplateString(type: any) {
    ...
    <div class="all-result-container">\
                    <div class="full-results-data-container">\
                        ...
                        <div class="powered-by-footer" style="display:none"><span class="logo-powered-by">Powered By</span> <img class="product-logo" src="https://koregeneric.s3.amazonaws.com/SearchAssist_UI_Img/kore_website_images/search-assist-product-logo.svg" /></div>\
                    </div>\
            </div>\
    </script>';
