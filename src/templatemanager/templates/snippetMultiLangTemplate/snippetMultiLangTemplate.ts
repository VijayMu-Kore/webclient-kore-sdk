...
class SnippetMultiLangTemplate {
    ...
    getTemplateString() {
        ...
        <div class="top-header">\
            ...
            <select class="selectTemplateDropdowm">\
                        <option>select</option> \
                            {{each(key, msgItem) snippetData.language_list}} \
                                <option  class="dropdownTemplatesValues" value="${msgItem}"> \
                                    ${msgItem}\
                                </option> \
                            {{/each}} \
                        </select> \
      ...
      {{if snippetData && snippetData.more_to_ask}}\
      <div class="more-to-ask-block">\
      <span class="more-to-ask-title">More to ask : </span>\
      {{each(key, data) snippetData.more_to_ask}}\
        <span class="more_to_ask_list" value="${data}">{{html data}}</span>\
        {{/each}}\
      </div>\
      {{/if}}\
