(function ($win) {
    $win.appConfig = {
        ...
        SMALLTALK_DEPTH:2,
        USE_SERVER_SOCKET_URL:true,//for on-prem's socket url is taken from browser url,this flag forces to pick only from server even on on-prem
        enableKoreMarketing : false
    };
})(window);